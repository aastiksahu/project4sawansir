...
<body>
    ...
    <jsp:useBean id="bean" class="com.rays.bean.MarksheetBean" scope="request"></jsp:useBean>
    <jsp:useBean id="coursebean" class="com.rays.bean.CourseBean" scope="request"></jsp:useBean>
